      ...
      <div className="bg-white/80 backdrop-blur-md shadow-sm border border-slate-200 rounded-2xl p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-base text-slate-900">{getRoleLabel(role)}</p>
          </div>
          ...
          {user.created_at && (
            <div>
              ...
              <p className="mt-1 text-base text-slate-900">{formatDate(user.created_at)}</p>
            </div>
          )}
        </div>
      </div>
        ...
        <div className="bg-white/80 backdrop-blur-md shadow-sm border border-slate-200 rounded-2xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-base text-slate-900">{institution.name}</p>
            </div>

            {/* Tipo de Institución */}
            <div>
              <label className="text-sm font-medium text-slate-700">Tipo</label>
              <p className="mt-1 text-base text-slate-900 capitalize">
